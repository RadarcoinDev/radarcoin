...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("Radarcoin Core radarcoin-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  radarcoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded radarcoin transaction") + "\n" +
                               "  radarcoin-tx [options] -create [commands]   " + _("Create hex-encoded radarcoin transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded radarcoin transaction
