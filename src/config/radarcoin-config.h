/* src/config/radarcoin-config.h.  Generated from radarcoin-config.h.in by configure.  */
/* src/config/radarcoin-config.h.in.  Generated from configure.ac by autoheader.  */
...
#define PACKAGE_BUGREPORT "www.radarcoin.org"

/* Define to the full name of this package. */
#define PACKAGE_NAME "Radarcoin Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "Radarcoin Core 1.0.0"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "radarcoin"
