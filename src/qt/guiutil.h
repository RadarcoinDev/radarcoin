...
/** Utility functions used by the Radarcoin Qt UI.
 */
namespace GUIUtil
{
...
// Render Radarcoin addresses in monospace font
...
// Parse "radarcoin:" URI into recipient object, return true on successful parsing
