...
bool Intro::pickDataDirectory()
{
    ...
    if (!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", false)) {
        ...
        while (true) {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("Radarcoin Core"),
     ...
     * override -datadir in the radarcoin.conf file in the default data directory
     * (to be consistent with radarcoind behavior)
     */
    if (dataDir != getDefaultDataDirectory())
