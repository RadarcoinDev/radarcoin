...
/* Radarcoin GUI -- Size of icons in status bar */
...
#define QAPP_ORG_NAME "Radarcoin"
#define QAPP_ORG_DOMAIN "radarcoin.org"
#define QAPP_APP_NAME_DEFAULT "Radarcoin-Qt"
#define QAPP_APP_NAME_TESTNET "Radarcoin-Qt-testnet"
