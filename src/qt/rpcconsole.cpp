                                          ...
                                          banTableContextMenu(0)
{
    ...
    std::string strzRADARPathCustom = GetArg("-zradarbackuppath", "");
    ...
    if(!strzRADARPathCustom.empty()) {
        ui->wallet_customzradarbackuppath->setText(QString::fromStdString(strzRADARPathCustom));
        ui->wallet_customzradarbackuppath_label->setVisible(true);
        ui->wallet_customzradarbackuppath->setVisible(true);
    }

    if((!strPathCustom.empty() || !strzRADARPathCustom.empty()) && nCustomBackupThreshold > 0) {
...
void RPCConsole::clear()
{
    ...
    message(CMD_REPLY, (tr("Welcome to the Radarcoin RPC console.") + "<br>" +
