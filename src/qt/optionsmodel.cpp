...
void OptionsModel::Init()
{
    ...
    if (!settings.contains("nDisplayUnit"))
        settings.setValue("nDisplayUnit", BitcoinUnits::RADAR);
...
// Wallet
    ...
    if (settings.contains("nAnonymizeRadarcoinAmount"))
        SoftSetArg("-anonymizeradarcoinamount", settings.value("nAnonymizeRadarcoinAmount").toString().toStdString());
...
void OptionsModel::Reset()
{
    ...
    settings.clear();
    resetSettings = true; // Needed in radarcoin.cpp during shotdown to also remove the window positions
