...
UniValue stop(const UniValue& params, bool fHelp)
{
    ...
    if (fHelp || params.size() > 1)
        throw runtime_error(
            "stop\n"
            "\nStop Radarcoin server.");
    // Event loop will exit after current HTTP requests have been handled, so
    // this reply will get back to the client.
    StartShutdown();
    return "Radarcoin server stopping";
}
...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* Radarcoin features */
        {"radarcoin", "listmasternodes", &listmasternodes, true, true, false},
        {"radarcoin", "getmasternodecount", &getmasternodecount, true, true, false},
        {"radarcoin", "masternodeconnect", &masternodeconnect, true, true, false},
        {"radarcoin", "createmasternodebroadcast", &createmasternodebroadcast, true, true, false},
        {"radarcoin", "decodemasternodebroadcast", &decodemasternodebroadcast, true, true, false},
        {"radarcoin", "relaymasternodebroadcast", &relaymasternodebroadcast, true, true, false},
        {"radarcoin", "masternodecurrent", &masternodecurrent, true, true, false},
        {"radarcoin", "masternodedebug", &masternodedebug, true, true, false},
        {"radarcoin", "startmasternode", &startmasternode, true, true, false},
        {"radarcoin", "createmasternodekey", &createmasternodekey, true, true, false},
        {"radarcoin", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"radarcoin", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"radarcoin", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"radarcoin", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"radarcoin", "getmasternodescores", &getmasternodescores, true, true, false},
        {"radarcoin", "preparebudget", &preparebudget, true, true, false},
        {"radarcoin", "submitbudget", &submitbudget, true, true, false},
        {"radarcoin", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"radarcoin", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"radarcoin", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"radarcoin", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"radarcoin", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"radarcoin", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"radarcoin", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"radarcoin", "checkbudgets", &checkbudgets, true, true, false},
        {"radarcoin", "mnsync", &mnsync, true, true, false},
        {"radarcoin", "spork", &spork, true, true, false},
        {"radarcoin", "getpoolinfo", &getpoolinfo, true, true, false},
        ...
        {"zerocoin", "getzradarseed", &getzradarseed, false, false, true},
        {"zerocoin", "setzradarseed", &setzradarseed, false, false, true},
        {"zerocoin", "generatemintlist", &generatemintlist, false, false, true},
        {"zerocoin", "searchdzradar", &searchdzradar, false, false, true},
        {"zerocoin", "dzradarstate", &dzradarstate, false, false, true},
...
{
    return "> radarcoin-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:41369/\n";
}
