...
/**
 * Radarcoin RPC command dispatcher.
 */
class CRPCTable
{
private:
...
extern UniValue DoZradarSpend(const CAmount nAmount, bool fMintChange, bool fMinimizeChange, vector<CZerocoinMint>& vMintsSelected, std::string address_str, bool isPublicSpend = true);
...
extern UniValue setzradarseed(const UniValue& params, bool fHelp);
extern UniValue getzradarseed(const UniValue& params, bool fHelp);
extern UniValue generatemintlist(const UniValue& params, bool fHelp);
extern UniValue searchdzradar(const UniValue& params, bool fHelp);
extern UniValue dzradarstate(const UniValue& params, bool fHelp);
