...
#ifndef Radarcoin_ZRADARTRACKER_H
#define Radarcoin_ZRADARTRACKER_H
...
public:
    CzRADARTracker(std::string strWalletFile);
    ~CzRADARTracker();
    void Add(const CDeterministicMint& dMint, bool isNew = false, bool isArchived = false, CzRADARWallet* zRADARWallet = NULL);
...
#endif //Radarcoin_ZRADARTRACKER_H
