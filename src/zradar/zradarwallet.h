...
#ifndef Radarcoin_ZRADARWALLET_H
#define Radarcoin_ZRADARWALLET_H
...
public:
    CzRADARWallet(std::string strWalletFile);
    ...
    void GenerateDeterministicZRADAR(libzerocoin::CoinDenomination denom, libzerocoin::PrivateCoin& coin, CDeterministicMint& dMint, bool fGenerateOnly = false);
    ...
    void UpdateCount();
    void Lock();
    void SeedToZRADAR(const uint512& seed, CBigNum& bnValue, CBigNum& bnSerial, CBigNum& bnRandomness, CKey& key);
...
#endif //Radarcoin_ZRADARWALLET_H
