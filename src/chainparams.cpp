...
public:
    CMainParams()
    {
        ...
        vSeeds.push_back(CDNSSeedData("172.86.75.55", "172.86.75.55"));
        vSeeds.push_back(CDNSSeedData("172.86.75.82", "172.86.75.82"));
	vSeeds.push_back(CDNSSeedData("172.86.75.246", "172.86.75.246"));
	vSeeds.push_back(CDNSSeedData("172.86.75.243", "172.86.75.243"));
	vSeeds.push_back(CDNSSeedData("172.86.75.251", "172.86.75.251"));
	vSeeds.push_back(CDNSSeedData("45.61.139.147", "45.61.139.147"));
