...
Radarcoin-Project/Radarcoin repository.
...
Setup
---------
Configuring the github-merge tool for the Radarcoin repository is done in the following way:

    git config githubmerge.repository Radarcoin-Project/Radarcoin
...
A script to optimize png files in the Radarcoin
...
If there are 'unsupported' symbols, the return value will be 1 a list like this will be printed:
    ...
    .../64/test_radarcoin: symbol memcpy from unsupported version GLIBC_2.14
    .../64/test_radarcoin: symbol __fdelt_chk from unsupported version GLIBC_2.15
    .../64/test_radarcoin: symbol std::out_of_range::~out_of_range() from unsupported version GLIBCXX_3.4.15
    .../64/test_radarcoin: symbol _ZNSt8__detail15_List_nod from unsupported version GLIBCXX_3.4.15
