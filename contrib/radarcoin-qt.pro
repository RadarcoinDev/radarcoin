...
SOURCES += src/activemasternode.cpp \
           ...
           src/obfuscation.cpp \
           src/radarcoin-cli.cpp \
           src/radarcoin-tx.cpp \
           src/radarcoin.cpp \
           src/db.cpp \
...
RESOURCES += src/qt/radarcoin.qrc src/qt/radarcoin_locale.qrc

TRANSLATIONS += src/qt/locale/radarcoin_bg.ts \
                src/qt/locale/radarcoin_de.ts \
                src/qt/locale/radarcoin_en.ts \
                src/qt/locale/radarcoin_es.ts \
                src/qt/locale/radarcoin_fi.ts \
                src/qt/locale/radarcoin_fr.ts \
                src/qt/locale/radarcoin_it.ts \
                src/qt/locale/radarcoin_ja.ts \
                src/qt/locale/radarcoin_pl.ts \
                src/qt/locale/radarcoin_pt.ts \
                src/qt/locale/radarcoin_ru.ts \
                src/qt/locale/radarcoin_sk.ts \
                src/qt/locale/radarcoin_sv.ts \
                src/qt/locale/radarcoin_vi.ts \
                src/qt/locale/radarcoin_zh_CN.ts \
                src/qt/locale/radarcoin_zh_TW.ts
