...
from fake_stake.base_test import Radarcoin_FakeStakeTest

class zRADARwrappedSerialsTest(Radarcoin_FakeStakeTest):
    ...
    def run_test(self):
        ...
        # 2) Mint zerocoins
        self.log.info("Minting %d-denom zRADARs..." % DENOM_TO_USE)
