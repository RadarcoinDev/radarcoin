Contributing to Radarcoin Core
============================

The Radarcoin Core project operates an open contributor model where anyone is
...
[Translation Process](https://github.com/radarcoin-project/radarcoin/blob/master/doc/translation_process.md)
...
The following applies to code changes to the Radarcoin Core project, and is not to be
confused with overall Radarcoin Network Protocol consensus changes.

Whether a pull request is merged into Radarcoin Core rests with the project merge
...
Patches that change Radarcoin consensus rules are considerably more involved than
...
Where a patchset proposes to change the Radarcoin consensus, it must have been
...
The project leader is the release manager for each Radarcoin Core release.
